...
public class DownloadResultFile extends BaseTest {

    @Test(
            groups = {
                    "MC:Download Result File",
                    "Abdul Rehman",
                    "SECTION:Batch Number Validation",
                    "SC:Batch Number"
            },
            description = "This test verifies the response when a valid batch number is used to request the Download Result File.",
            priority = 1
    )
    public void getValidBatchNumberNoDownloadFileTestCase() {

        AppUtils.getValidBatchNumberNoDownloadFileTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getInvalidBatchNumberNoDownloadFileTestCase() {
        ...
        AppUtils.getInvalidBatchNumberNoDownloadFileTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getMissingBatchNumberTestCase() {
        ...
        AppUtils.getMissingBatchNumberTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getIncorrectFormatBatchNumberTestCase() {
        ...
        AppUtils.getIncorrectFormatBatchNumberTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getBatchNumberDifferentValidKeyTestCase() {
        ...
        AppUtils.getBatchNumberDifferentValidKeyTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getValidBatchNumberTestCase() {
        ...
        AppUtils.getValidTotalRecordsTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getSumOfRecordsTestCase() {
        ...
        AppUtils.getSumOfRecordsTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getNegativeTotalRecordsTestCase() {
        ...
        AppUtils.getNegativeTotalRecordsTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getTimestampValidationTestCase() {
        ...
        AppUtils.getTimestampValidationTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getNonNegativeRecordsTestCase() {
        ...
        AppUtils.getNonNegativeRecordsTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
    ...
    public void getNonNegativeTimestampsTestCase() {
        ...
        AppUtils.getNonNegativeTimestampsTestCase(AppConstants.RESULT + "/" + AppConstants.DOWNLOAD);
    }
}
